...
export default class Navbar extends Component {
	...
	render() {
		return (
			<div className="main-navbar-vp absolute top-0 right-0 w-screen shadow-md flex flex-nowrap justify-between items-center bg-gray-900 text-ubt-grey text-sm select-none z-50">
				<div
					tabIndex="0"
					className={
						'font-sans pl-3 pr-3 outline-none transition duration-100 ease-in-out border-b-2 border-transparent focus:border-ubb-orange py-1 '
					}
				>
					Activities
				</div>
